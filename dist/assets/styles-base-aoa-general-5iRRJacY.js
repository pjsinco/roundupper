...
`}function g(t,i,l){return`
      <img src="${t}" style="max-width: 600px; border: 0; display: block; outline: none; text-decoration: none; height: auto; font-size: 13px;" title=${i} alt="${l}" />`}return{paragraph:h,heading:f,link:c,list:p,image:g}}export{o as C,m as a,n as b,d as u};
